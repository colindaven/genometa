...
\begin{tabular}{|p{7cm}|p{7cm}|}
\hline
\multicolumn{2}{|c|}{\textbf{RefSeq code to species name}}\\
\hline
\textbf{A name will be mapped to RefSeq code.}
&
\begin{itemize}
	\item show RefSeq and name
\end{itemize}
\\
\hline
\end{tabular}
...
&
\begin{itemize}
	\item export information to CSV-File
\end{itemize}
\\
\hline
\end{tabular}
...
\hline
\textbf{Export graph to vector format.}
&
\begin{itemize}
	\item SVG or PDF
	\item PNG
...
&
\begin{itemize}
	\item export them to a list with coordinates and sequence
\end{itemize}
\\
\hline
\end{tabular}
